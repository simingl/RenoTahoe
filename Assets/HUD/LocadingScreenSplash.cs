...
public class LocadingScreenSplash : MonoBehaviour {
		//We make a static variable to our LoadingScreen instance
	static LocadingScreenSplash instance;
		...
		void Awake()
		{
			...
			loadingScreenImage = GameObject.Find("LoadingScreen");
